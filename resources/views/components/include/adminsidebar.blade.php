    ...
    <div class="sidebar">
        ...
        <div class="nav-item">
            ...
            <div class="collapse" id="learnDropdown">
                <a href="{{url('treasurer/create/announcement')}}" class="nav-link ps-4">Create Announcement</a>
                <a href="{{url('treasurer/create/purpose')}}" class="nav-link ps-4">Create Purpose</a>
            </div>
        </div>
