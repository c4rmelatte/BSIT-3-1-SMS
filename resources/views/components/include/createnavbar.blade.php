...
.list-group-item.active {
    ...
    <div class="list-group">
        ...
        <a href="{{ url('/studentlist') }}" class="list-group-item list-group-item-action">ITPC 11 / BSIT 3-1</a>
        <a href="#" class="list-group-item list-group-item-action">ITPE 2 / BSIT 3-1</a>
        <a href="#" class="list-group-item list-group-item-action">ITPC 11 / BSIT 3-2</a>
        <a href="#" class="list-group-item list-group-item-action">GEE 2 / BSECE 2-2</a>
</div>
