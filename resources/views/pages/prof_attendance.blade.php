...
<body>
    <div class="top">
        ...
        <div class="name-line">
            <span id="nameRole">RANIEL GABRIEL</span>
            <span id="idNo">{{ $subject->professor_id }}</span>
        </div>
        
        <!-- Sample subject -->
        <!-- <input type="hidden" id="subjectName" value="{{ $subject->subject_code }}">
        <input type="hidden" id="subjectSched" value="{{ $subject->course_year_block }}"> -->
        
        <div class="subSched">
            <span id="subj">{{ $subject->subject_code }}</span>
            <span id="subjectSchedDisplay">{{ $subject->course_year_block }}</span>
        </div>
    </div>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        @csrf
                            ...
                            <input type="hidden" name="subjectID" value="{{ $subject->subject_id }}">
                            <input type="hidden" name="courseYearBlock" value="{{ $subject->course_year_block }}">
