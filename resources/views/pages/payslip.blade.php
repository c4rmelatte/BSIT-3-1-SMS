...
<body>
    ...
    <div class="payroll-container">
        ...
        <div class="payroll-section">
            ...
            <input type="text" id="employeeName" name="employeeName" value="{{ $employeeName->name }}"  required readonly>
            
            <label for="employeeID">Employee ID:</label>
            <input type="text" id="employeeID" name="employeeID" value="{{ $employee->id_number }}" required readonly>
            ...
            <input type="text" id="baseSalary" name="baseSalary" value="₱{{ number_format($employee->base_salary, 2) }}" required readonly>
            
            <label for="additionalHours">Additional Hours:</label>
            <input type="text" id="additionalHours" name="additionalHours" value="₱{{ number_format($employee->additional_hours, 2) }}" readonly>
        ...
        <div class="payroll-section">
            ...
            <input type="text" id="federalTax" name="federalTax" value="-₱{{ number_format($employee->tax, 2) }}" required readonly>
