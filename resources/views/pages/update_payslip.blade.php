...
<body>
    ...
    <form action="{{ route('insert.updated.payslip') }}" method="POST">
        @csrf
        @method('PUT')
        <div class="payroll-container">
            <div class="payroll-section">
                ...
                <input type="text" id="employeeID" name="employeeID" value="{{ $employee->id_number }}" readonly required><br><br>
                ...
                <input type="month" id="payPeriod" name="payPeriod" value="{{ $employee->pay_period }}" readonly required><br><br>
                
                <label for="payDate">Pay Date:</label><br>
                <input type="date" id="payDate" name="payDate" value="{{ $employee->pay_date }}" required><br><br>

                <h2>Earnings</h2>
                <label for="baseSalary">Base Salary: (₱)</label><br>
                <input type="number" id="baseSalary" name="baseSalary" value="{{ $employee->base_salary }}" required><br><br>
                
                <label for="additionalHours">Additional Hours: (₱)</label><br>
                <input type="number" id="additionalHours"  name="additionalHours" value="{{ $employee->additional_hours }}"><br><br>
                
                <label for="bonus">Bonus: (₱)</label><br>
                <input type="number" id="bonus" name="bonus" value="{{ $employee->bonus }}"><br><br>
            ...
            <div class="payroll-section">
                ...
                <input type="number" id="federalTax" name="federalTax" value="{{ $employee->tax }}" required><br><br>
                
                <label for="healthInsurance">Health Insurance: (₱)</label><br>
                <input type="number" id="healthInsurance" name="healthInsurance" value="{{ $employee->insurance }}"><br><br>
                
                <label for="retirementContribution">Retirement Contribution: (₱)</label><br>
                <input type="number" id="retirementContribution" name="retirementContribution" value="{{ $employee->retirement_contribution }}"><br><br>
                ...
                <input type="text" id="accountDigits" name="accountDigits" value="{{ $employee->account_number }}" required pattern="\d{4}"><br><br>
                
                <!-- <label for="paymentDate">Date:</label><br>
                <input type="date" id="paymentDate" na  me="paymentDate" required><br><br> -->

                <div class="button-container">
                    <button type="submit" class="create-button" id="create">UPDATE</button>
                </div>
