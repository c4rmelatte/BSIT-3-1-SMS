    ...
    <div class="container">
        ...
        <div class="box">
                ...
                <form action="{{ route('check.id') }}" method="get" class="form-container">
                    ...
                    <input type="text" name="idInput" value="{{ session('idInput') }}" placeholder="Insert ID Number" class="input-field">
        ...
        .submit-button:hover, #timeInButton:hover {
