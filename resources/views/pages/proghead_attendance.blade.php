...
<body>
    ...
    <div class="top">
        <div class="progHead">
            <span id="name">{{ $programHeadName->name }} (Program Head)</span>
    ...
    <div class="bottom">
        ...
        <button class="buttons" data-bs-toggle="modal" data-bs-target="#exampleModal">DESCRIPTION</button>
        <button class="buttons" onclick="document.getElementById('updateEventAttendanceForm').submit()" class="btn-add" id="add">SAVE</button>
        <button class="buttons" onclick="document.getElementById('editEventAttendanceForm').submit()" class="btn-add" id="add">EDIT</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Event Description</h5>
