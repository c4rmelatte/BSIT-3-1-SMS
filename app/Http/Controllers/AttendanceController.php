...
class AttendanceController extends Controller
{
    ...
    public function showEventAttendance(Request $request) {
    ...
    public function showStudentSubjects(Request $request) {
    ...
    public function showStudentAttendancePage(Request $request) {
    ...
    public function showSubjectAttendance(Request $request) {
