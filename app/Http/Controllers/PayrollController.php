...
class PayrollController extends Controller
{
    ...
    public function insertPayslip(Request $request) {
        ...
        $employee = DB::table('example_user')->where('role', '!=', 'student')->where('user_id', $id)->first();
    ...
    public function findEmployee(Request $request) {
        ...
        $employee = DB::table('employee_payroll')->where('id_number', $id)->where('pay_period', $month)->first();
    ...
    public function insertUpdatedPayslip(Request $request) {
        ...
        DB::table('employee_payroll')->where('id_number', $employeeID)->where('pay_period', $payPeriod)->update([
    ...
    public function showPayslip(Request $request) {
        ...
        return view('pages/payslip', ['employee' => $employee,
    ...
    public function deletePayslip(Request $request) {
        ...
        DB::table('employee_payroll')->where('id_number', $id)->where('pay_period', $month)->delete();
